...
const DefaultPanelGitHubRepository = "https://github.com/meglinge/Cli-Proxy-API-Management-Center"
...
type RoutingConfig struct {
	...
	// Supported values: "round-robin" (default), "fill-first", "quota-weighted".
